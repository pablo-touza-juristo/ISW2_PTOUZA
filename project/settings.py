...
SECRET_KEY = config('SECRET_KEY', default='_*&5c@1153xw6=489*2*=&*%=4)8f^m54kb@3ca-cb(wm%b@wm')

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = config('DEBUG', default=True, cast=bool)

ALLOWED_HOSTS = [
    'practica-f2hshnd6endrgshc.switzerlandnorth-01.azurewebsites.net',
    'localhost',
    '127.0.0.1'
]

CSRF_TRUSTED_ORIGINS = [
    'https://practica-f2hshnd6endrgshc.switzerlandnorth-01.azurewebsites.net',
]
...
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'relecloud/static'),
]
